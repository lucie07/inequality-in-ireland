...
(function (a) {
    ...
    r(a, "Accessibility/Utils/ChartUtilities.js", [a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h) {
        ...
        var l = a.stripHTMLTagsFromString, g = h.defined, x = h.find, k = h.fireEvent;
        return {
            ...
            }, getSeriesFirstPointElement: m, getSeriesFromName: function (e, d) {
                return d ? (e.series || []).filter(function (b) {
                    return b.name === d
                }) : e.series
            }, getSeriesA11yElement: n, unhideChartElementFromAT: p,
            hideSeriesFromAT: function (e) {
                (e = n(e)) && e.setAttribute("aria-hidden", !0)
            }, scrollToPoint: function (e) {
                var d = e.series.xAxis, b = e.series.yAxis, f = (null === d || void 0 === d ? 0 : d.scrollbar) ? d : b;
                if ((d = null === f || void 0 === f ? void 0 : f.scrollbar) && g(d.to) && g(d.from)) {
                    b = d.to - d.from;
                    if (g(f.dataMin) && g(f.dataMax)) {
                        var c = f.toPixels(f.dataMin), w = f.toPixels(f.dataMax);
    ...
    r(a, "Accessibility/KeyboardNavigationHandler.js", [a["Core/Utilities.js"]], function (a) {
        ...
        m.prototype = {
            run: function (a) {
                var m = a.which || a.keyCode, l = this.response.noHandler, g = q(this.keyCodeMap, function (a) {
    ...
    r(a, "Accessibility/AccessibilityComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/EventProvider.js"],
        ...
        var m = a.win, k = m.document;
        a = h.extend;
        var e = h.fireEvent, d = h.merge, b = q.removeElement, f = q.getFakeMouseEvent, c = n.unhideChartElementFromAT;
        g.prototype = {
            initBase: function (b) {
                this.chart = b;
    ...
    r(a, "Accessibility/KeyboardNavigation.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/Utils/EventProvider.js"]], function (a, h, q, n) {
        ...
        var l = a.doc, g = a.win, x = h.addEvent, k = h.fireEvent, e = q.getElement;
        ...
        m.prototype = {
            init: function (d, b) {
                var f = this, c = this.eventProvider = new n;
                this.chart = d;
                this.components = b;
                this.modules = [];
            ...
            next: function () {
                ...
                d = !(d && !1 === d.enabled);
                var b = this.chart, f = b.container;
            ...
            makeElementAnExitAnchor: function (d) {
                ...
                var d = this.chart, b = this.exitAnchor = l.createElement("div");
    ...
    r(a, "Accessibility/Components/LegendComponent.js", [a["Core/Globals.js"], a["Core/Legend.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, q, n, p, l) {
        ...
        var m = q.addEvent,
            k = q.extend, e = q.find, d = q.fireEvent, b = l.stripHTMLTagsFromString, f = l.removeElement;
        a.Chart.prototype.highlightLegendItem = function (b) {
            ...
            if (c[b]) {
                ...
                a = this.legend;
                var f = a.allItems[b].pageIx, e = a.currentPage;
        ...
        k(a.prototype, {
            init: function () {
                ...
                var b = this.chart.legend, d = b.currentPage || 1, a = b.clipHeight || 0;
                (b.allItems || []).forEach(function (c) {
                    var f = c.pageIx || 0, e = c._legendItemPos ? c._legendItemPos[1] : 0,
                ...
                var c = this.keyCodes, a = b.response, f = this.chart, e = f.options.accessibility,
                ...
                var b = this.chart, d = b.colorAxis && b.colorAxis.length,
    ...
    r(a, "Accessibility/Components/MenuComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, q, n, p, l) {
        ...
        h = h.extend;
        var m = p.unhideChartElementFromAT, k = l.removeElement,
        ...
        h(a.prototype, {
            init: function () {
                ...
                var d = this.chart, b = d.exportContextMenu;
                ...
                var d = this.chart, b = d.options.accessibility;
                k(this.exportProxyGroup);
                var a = d.options.exporting, c = g(d);
                ...
                var d = this.chart, b = d.exportDivElements;
                ...
                var d = this.keyCodes, b = this.chart, a = this;
                return new n(b, {
                    keyCodeMap: [[[d.left, d.up], function () {
                        ...
                        var c =
                            a.exportButtonProxy, d = b.exportingGroup;
                ...
                var b = this.chart, a = b.exportDivElements[b.highlightedExportItemIx], c = g(b).element;
    ...
    r(a, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js", [a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"], a["Accessibility/KeyboardNavigationHandler.js"],
        ...
        function m(b) {
            var c = b.index, d = b.series.points, a = d.length;
            if (d[c] !== b) for (; a--;) {
                if (d[a] === b) return a
            } else return c
        }
        ...
        function k(b) {
            var c = b.chart.options.accessibility.keyboardNavigation.seriesNavigation,
                d = b.options.accessibility || {}, a = d.keyboardNavigation;
        ...
        function d(b, d, a, e) {
            var f = Infinity, k = d.points.length, l = function (b) {
        ...
        var c = n.defined;
        n = n.extend;
        var w = g.getPointFromXY, A = g.getSeriesFromName, z = g.scrollToPoint;
        ...
        a.prototype.highlightAdjacentPoint = function (b) {
            var c = this.series, d = this.highlightedPoint, a = d && m(d) || 0, f = d && d.series.points,
        ...
        h.Series.prototype.highlightFirstValidPoint = function () {
            var b = this.chart.highlightedPoint, c = (b && b.series) === this ? m(b) : 0;
            b = this.points;
            var d = b.length;
            if (b && d) {
        ...
        n(f.prototype, {
            init: function () {
                var c = this, a = this.chart, d = this.eventProvider = new l;
                ...
                var b = this.lastDrilledDownPoint, a = this.chart, d = b && A(a, b.seriesName), f;
            ...
            onHandlerInit: function (c, a) {
                ...
                var b, c, a = this.chart, d = a.highlightedPoint;
    ...
    r(a, "Accessibility/Components/AnnotationsA11y.js", [a["Accessibility/Utils/HTMLUtilities.js"]],
        function (a) {
            ...
            function n(a) {
                var k, e,
                    d = null === (e = null === (k = a.options) || void 0 === k ? void 0 : k.accessibility) || void 0 ===
            ...
            return {
                ...
                getAnnotationListItems: p, getPointAnnotationTexts: function (a) {
    ...
    r(a, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [a["Core/Utilities.js"], a["Accessibility/Components/AnnotationsA11y.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/Tooltip.js"]], function (a, h, q, n, p) {
        ...
        function c(b) {
            var c = f(b),
                ...
                d = b.id && 0 > b.id.indexOf("highcharts-"), e =
                "x, " + b.x;
        ...
        function A(b) {
            var c = b.series, a = c.chart.options.accessibility.point || {}, d = c.tooltipOptions || {},
        ...
        function z(b) {
            var a = b.series, d = a.chart, f = d.options.accessibility.point.valueDescriptionFormat,
        ...
        function B(a) {
            var c = a.chart, f = c.types || [], e = d(a), k = function (b) {
                return c[b] && 1 < c[b].length && a[b]
            }, l = b(a, "xAxis"), v = b(a, "yAxis"), g = {
                name: a.name || "",
                ix: a.index + 1,
        ...
        var C = a.find, u = a.format, v = a.isNumber, I = a.numberFormat, y = a.pick, D = a.defined,
            H = h.getPointAnnotationTexts, F = q.escapeStringForHTML, K = q.reverseChildNodes,
        ...
        return {
            describeSeries: function (b) {
                var a = b.chart, c = L(b), d = M(b), f = a.is3d && a.is3d();
                if (d) {
                    d.lastChild !==
                    c || f || K(d);
                    r(b);
    ...
    r(a, "Accessibility/Components/SeriesComponent/NewDataAnnouncer.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Components/SeriesComponent/SeriesDescriber.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/Utils/EventProvider.js"]], function (a, h, q, n, p, l) {
        ...
        var k = h.extend, e = h.defined, d = q.getChartTitle, b = n.defaultPointDescriptionFormatter,
        ...
        k(h.prototype, {
            init: function () {
                ...
                var b = this, d = this.chart, f = this.eventProvider;
                ...
                var c = this, f = this.chart.options.accessibility.announceNewData;
                if (f.enabled) {
                    var e = +new Date;
                    f = Math.max(0,
                    ...
                    if (a = this.buildAnnouncementMessage(b, a, d)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
                        ...
                        c && c.announcer && (c.lastAnnouncementTime = +new Date, c.announcer.announce(c.queuedAnnouncement.message), delete c.queuedAnnouncement, delete c.queuedAnnouncementTimer)
                                                   ...
                                                   e, k) {
                var l = this.chart, g = l.options.accessibility.announceNewData;
    ...
    r(a, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [a["Core/Globals.js"],
        ...
        var n = h.addEvent, p = h.merge;
        return function () {
            n(a.Series, "render", function () {
                var a = this.options, g = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
                ...
                if (g) {
                    ...
                    (this.a11yMarkersForced = !0, m(this.options)), this._hasPointMarkers && this.points && this.points.length) for (a = this.points.length; a--;) {
                        g = this.points[a];
                        var h = g.options;
    ...
    r(a, "Accessibility/Components/SeriesComponent/SeriesComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js"], a["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"], a["Accessibility/Components/SeriesComponent/ForcedMarkers.js"],
        ...
        h = h.extend;
        var e = g.hideSeriesFromAT, d = x.describeSeries;
    ...
    r(a, "Accessibility/Components/ZoomComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]],
        function (a, h, q, n, p, l) {
            var g = h.extend, m = h.pick, k = p.unhideChartElementFromAT, e = l.setElAttrs, d = l.removeElement;
            ...
            g(a.prototype, {
                init: function () {
                    ...
                    var d = this.keyCodes, e = this, f = this.chart;
                    return new n(f, {
    ...
    r(a, "Accessibility/Components/RangeSelectorComponent.js", [a["Core/Globals.js"],
        ...
        h = h.extend;
        var g = p.unhideChartElementFromAT, m = l.setElAttrs;
        ...
        h(a.prototype, {
            onChartUpdate: function () {
                ...
                var d = a.response, b = this.keyCodes, f = this.chart,
    ...
    r(a, "Accessibility/Components/InfoRegionsComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"],
        ...
        var k = a.doc, e = h.extend, d = h.format, b = h.pick, f = p.getAnnotationsInfoHTML,
            c = l.unhideChartElementFromAT,
            w = l.getChartTitle, r = l.getAxisDescription, z = g.addClass, t = g.setElAttrs, E = g.escapeStringForHTML,
            B = g.stripHTMLTagsFromString, C = g.getElement, u = g.visuallyHideElement;
        ...
        e(h.prototype, {
            init: function () {
                ...
                var a = this.chart, d = this.screenReaderSections[b], e = d.buildContent(a),
                ...
                var b = this.chart, a = b.langFormat("accessibility.screenReaderSection.endOfChartMarker", {chart: b});
    ...
    r(a, "Accessibility/Components/ContainerComponent.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/AccessibilityComponent.js"]], function (a, h, q, n, p) {
        ...
        a = h.extend;
        var g =
            q.stripHTMLTagsFromString, m = n.unhideChartElementFromAT, k = n.getChartTitle;
        q = function () {
        };
        q.prototype = new p;
        a(q.prototype, {
            onChartUpdate: function () {
                ...
                var a = this.chart, d = g(a.langFormat("accessibility.svgContainerLabel", {chartTitle: k(a)}));
    ...
    r(a, "Accessibility/HighContrastMode.js", [a["Core/Globals.js"]], function (a) {
        var h = a.isMS, m = a.win, n = m.document;
        return {
    ...
    r(a, "Accessibility/Options/DeprecatedOptions.js", [a["Core/Utilities.js"]],
        function (a) {
            ...
            function m(a, e, d, b) {
                ...
                var c = f(a.options, e), l = f(a.options, d);
    ...
    r(a, "Accessibility/FocusBorder.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"],
        ...
        k(h.prototype, {
            addFocusBorder: function (b, d) {
                ...
                var c = this.getBBox(), f = e(b, 3);
                c.x += this.translateX ? this.translateX : 0;
                c.y += this.translateY ? this.translateY : 0;
                var g = c.x - f, h = c.y - f, k = c.width + 2 * f, n = c.height + 2 * f, p = this instanceof q;
        ...
        a.Chart.prototype.setFocusToElement = function (a, d) {
            ...
            d.hcEvents.focusin || r(d, "focusin", function () {
    ...
    r(a, "Accessibility/Accessibility.js", [a["Accessibility/Utils/ChartUtilities.js"], a["Core/Globals.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Core/Options.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigation.js"],
        ...
        var u = l.addEvent, v = l.extend, x = l.fireEvent, y = l.merge, D = h.win.document;
        ...
        m.prototype = {
            init: function (a) {
                ...
                var a = this.chart, g = a.options.accessibility;
                this.components = {
                    container: new w,
                    infoRegions: new c,
                    legend: new k,
