...
var config = {
    ...
    chapters: [
...

        {
            ...
            title: '    ',
            image: '',
            legend: '../legendImg/c_totpop16.png',
...
Highcharts.chart('container3', {
    ...
    title: {
        text: 'Co.Dublin Deprevasion Index Score Range, 2016'
    },
    xAxis: {
        categories: ['']
    },
...
Highcharts.chart('container8', {
    ...
    series: [{
        ...
        innerSize: '50%',
        data: [
            ['higher level education', 6.1],
            ['stopped at primary level', 32.7],
...
Highcharts.chart('container11', {
    ...
    xAxis: {
        categories: ['PRIORSWOOD B', 'FINGLAS' +'\<br>' +'SOUTH C', 'TALLAGHT'+'\<br>' +'-KILLINARDAN', 'KILMORE C', 'TALLAGHT' +'\<br>' +'-AVONBEG']
    },
    yAxis: {
        categories: ['Population' +'\<br>' +'Change', 'Unemployment' +'\<br>' +
        '- Male', 'Unemployment' +'\<br>' +
